(function(){
  ...
  var css='@import url("https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap");'
    ...
    +'.gc{display:grid;grid-template-columns:80px 1fr auto;align-items:center;gap:18px;background:#151515;border:1px solid #222;border-radius:6px;padding:18px 20px;transition:border-color 0.2s;border-left:3px solid #222;}'
    ...
    +'.gd .gm{font-size:12px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#C9A84C;}'
    +'.gd .gdy{font-size:32px;font-weight:700;line-height:1.1;color:#fff;}'
    +'.gd .gw{font-size:12px;font-weight:500;letter-spacing:1px;text-transform:uppercase;color:rgba(255,255,255,0.35);}'
    +'.gi{display:flex;flex-direction:column;gap:4px;min-width:0;}'
    +'.go{font-size:17px;font-weight:600;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}'
    +'.gdt{font-size:13px;color:rgba(255,255,255,0.5);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}'
    +'.gtl{font-size:12px;font-weight:600;letter-spacing:1px;text-transform:uppercase;margin-top:3px;}'
    ...
    +'.bd{font-size:11px;font-weight:600;letter-spacing:1.5px;text-transform:uppercase;padding:5px 12px;border-radius:4px;}'
    +'.bd.hm{background:#C9A84C;color:#0d0d0d;}.bd.aw{background:rgba(201,168,76,0.3);color:#fff;}'
    +'.rb{font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;padding:5px 12px;border-radius:4px;}'
    ...
    +'.st{font-size:16px;font-weight:600;color:rgba(255,255,255,0.5);}'
    +'.em{text-align:center;color:rgba(255,255,255,0.5);font-size:13px;padding:24px 0;}'
    +'@media(max-width:600px){.root{padding:16px 10px;}.cc{min-height:60px;padding:3px;}.ce{font-size:7px;padding:1px 3px;}.cdh{font-size:9px;padding:6px 2px;}.gc{grid-template-columns:68px 1fr;gap:12px;padding:16px 14px;}.gme{grid-column:1/-1;flex-direction:row;align-items:center;gap:8px;}.gd .gdy{font-size:28px;}.gd .gm{font-size:11px;}.gd .gw{font-size:11px;}.go{font-size:16px;}.gdt{font-size:12px;}.gtl{font-size:11px;}.bd{font-size:10px;padding:4px 10px;}.rb{font-size:10px;padding:4px 10px;}.st{font-size:14px;}.fb{font-size:8px;padding:5px 10px;}}';
