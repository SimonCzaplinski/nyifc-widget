(function () {
  ...
  var CSS = [
    ...
    '.division-title{font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:rgba(255,255,255,0.8)}',
    ...
    '.standings-table th{font-size:10px;font-weight:600;letter-spacing:1.5px;text-transform:uppercase;color:#C9A84C;padding:9px 8px;text-align:center;white-space:nowrap}',
    '.standings-table th.col-team{text-align:left;padding-left:12px}',
    '.standings-table td{font-size:12px;font-weight:400;padding:8px 8px;text-align:center;color:rgba(255,255,255,0.75);border-bottom:1px solid rgba(255,255,255,0.04)}',
    '.standings-table td.col-team{text-align:left;padding-left:12px;font-weight:500;color:rgba(255,255,255,0.9)}',
    '.standings-table td.col-pts{font-weight:700;font-size:13px;color:#fff}',
    '.standings-table td.col-rank{color:rgba(255,255,255,0.35);font-size:11px;width:32px}',
    ...
    '.standings-table td{font-size:11px;padding:7px 5px}',
    '.standings-table td.col-team{padding-left:8px}',
    '.standings-table th{font-size:9px;padding:8px 5px}',
